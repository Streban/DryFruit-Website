...
export const productsData: Record<string, Product> = {
    ...
    types: [
      {
        ...
        origin: "Peshawar - Kambri",
        calibre: "26/28 per ounce – Kambri",
        application:
      ...
      },
      {
        ...
        origin: "Kalat – Kalam Dana",
        calibre: "30/32 per ounce – Kalamdana",
        application:
      ...
      },
      {
        ...
        origin: "Skardu – Katta Jumbo",
        calibre: "20/22 per ounce – Katta Jumbo",
        application:
  ...
  raisin: {
    ...
    types: [
      {
        id: "kala-pishin",
        images: ["/assets/images/Images-2/Kala Pishin - Black Raisin.png"],
        origin: "Pishin",
        reasonToBelieve:
          "Rich, chewy, and full-bodied with deep, fruity flavor - (Kala Pishin / Black Raisin)",
        name: "Kala Pishin",
        application: "Snacks, hearty breads, pilafs, stews",
        calibre: "55/65 per ounce – (Kala Pishin / Black Raisin)",
      },
      {
        id: "peela-kandhari",
        images: ["/assets/images/Images-2/Peela Khandhari - Golden Raisin.png"],
        origin: "Kandahar",
        reasonToBelieve:
          "Juicy, sweet, and slightly chewy, with a natural sugary taste - (Peela Kandhari / Golden Raisin)",
        name: "Peela Khandhari",
        application:
          "Cakes, cereals, salads, chutneys – (Peela Kandhari / Golden Raisin)",
        calibre: "45/55 per ounce – (Peela Kandhari / Golden Raisin)",
      },
      {
        id: "sultana",
        images: ["/assets/images/Images-2/Sultana Raisin.png"],
        origin: "Chaman",
        reasonToBelieve:
        ...
        calibre: "50/60 per ounce – (Sultana Raisin)",
      },
    ],
    ...
    types: [
      {
        ...
        calibre: "45/50 per ounce – Ziarat Pista",
        origin: "Quetta – Ziarat Pista",
        reasonToBelieve:
      ...
      },
      {
        ...
        calibre: "40/45 per ounce – Killa Saifullah Pista",
        origin: "Kalat – Killa Saifullah Pista",
        reasonToBelieve:
    ...
    types: [
      {
        ...
        calibre: "6/8 halves per ounce – Swat-dir",
        origin: "Swat – Swat-dir",
        reasonToBelieve:
      ...
      },
      {
        ...
        calibre: "10/12 halves per ounce – Kaghzi",
        origin: "Gilgit – Kaghzi",
        reasonToBelieve:
  ...
  pinenuts: {
    ...
    types: [
      {
        id: "banu-chilas",
        name: "Banu-Chilas Pinenuts",
        origin: "Bannu - Banu Chillas",
        calibre: "150/160 per ounce - Banu Chillas",
        application:
          "Luxury pesto, gourmet baked goods, salad & grain bowl, fine pastry & confections",
        reasonToBelieve:
      ...
      },
      {
        ...
        origin: "Waziristan - Waziri",
        calibre: "120/130 per ounce - Waziri",
        application:
          "Artisan confections, fine chocolate, creamy desserts or cheese boards, luxury snack",
        reasonToBelieve:
    ...
    types: [
      {
        ...
        calibre: "150/155 per ounce – Fara ka",
        origin: "Layyah - Fara Ka",
        reasonToBelieve:
      ...
      },
      {
        ...
        calibre: "145/150 per ounce - Khilay",
        origin: "Thal - Khilay",
        reasonToBelieve:
    ...
    varieties: [
      {
        ...
        description:
          "Fara ka hazelnuts are grown in parts northwest Pakistan. They are small to medium in size and offer a rich, earthy, nutty flavor. These hazelnuts are typically consumed raw or peeled and roasted, ideal for use in chocolate spreads, desserts, and trail mixes.",
        availability: createAvailability([9, 10, 11, 12, 1]),
      },
      {
        id: "fara-ka-peeled",
      ...
      },
      {
        ...
        description:
          "Another regional variant, Khilay hazelnuts are known for their intense flavor and crunchy texture. Peeled Khilay hazelnuts are especially favored in winter dry fruit assortments. Their strong aroma and creamy taste make them well-suited for confectionery or energy bars.",
        availability: createAvailability([9, 10, 11, 12, 1]),
      },
      {
        id: "khilay-peeled",
    ...
    types: [
      {
        ...
        calibre: "45/50 per ounce - Para Chinar",
        origin: "Para Chinar - Para Chinar",
        reasonToBelieve:
      ...
      },
      {
        ...
        calibre: "50/55 per ounce - Chakwali",
        origin: "Chakwal - Chakwali",
        reasonToBelieve:
    ...
    types: [
      {
        ...
        calibre: "4/5 per ounce - Regular",
        origin: "Chitral – Regular",
        reasonToBelieve:
          "Classic sweet-chewy flavour, nutrient-rich and slightly earthy undertone - Regular",
        images: ["/assets/images/Images-2/Fig Regular.png"],
      },
      {
        id: "chitrali-premium",
        ...
        calibre: "3/4 per ounce – Premium",
        origin: "Chitral – Premium",
        reasonToBelieve:
          "Tree-sun dried for enhanced sweetness, lighter appearance & larger size, gourmet appeal - Premium",
        images: ["/assets/images/Images-2/Fig Premium.png"],
      },
    ],
    ...
    types: [
      {
        ...
        images: ["/assets/images/Images-2/Kishta Apricot.png"],
      },
      {
        id: "gol",
        name: "Gol Apricot",
        ...
        images: ["/assets/images/Images-2/Gol Apricot.png"],
      },
      {
        id: "naag",
        name: "Naag Apricot",
        ...
        images: ["/assets/images/Images-2/Naag Apricot.png"],
      },
    ],
